...
**Write all prose in ASD-STE100 Simplified Technical English** — the `docs/agents/*.md` files, the `## Agent skills` block, and your messages to the user. **REQUIRED SUB-SKILL:** `/terebentina:ste`.
