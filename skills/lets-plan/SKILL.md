...
5. If a question can be answered by exploring existing codebase or documentation, explore that instead.
6. Stop when no unresolved decisions would change the outcome, or remaining questions are cosmetic.
